...
adj([hero | L],L,Entity, [prop(Entity, type, hero)|C],C).
adj([support | L],L,Entity, [prop(Entity, role, support)|C],C).
adj([nuker | L],L,Entity, [prop(Entity, role, nuker)|C],C).
adj([disabler | L],L,Entity, [prop(Entity, role, disabler)|C],C).
adj([jungler | L],L,Entity, [prop(Entity, role, jungle)|C],C).
adj([jungle | L],L,Entity, [prop(Entity, role, jungle)|C],C).
adj([durable | L],L,Entity, [prop(Entity, role, durable)|C],C).
adj([escape | L],L,Entity, [prop(Entity, role, escape)|C],C).
adj([pusher | L],L,Entity, [prop(Entity, role, pusher)|C],C).
adj([initiator | L],L,Entity, [prop(Entity, role, initiator)|C],C).
adj([carry | L],L,Entity, [prop(Entity, role, carry)|C],C).
...
reln([can,beat | L],L,O1,O2, [prop(O1, counters, O2) | C],C).
reln([is,good,against | L],L,O1,O2, [prop(O1, counters, O2) | C],C).
reln([synergizes,with| L],L,O1,O2, [prop(O1, synergizes, O2) | C],C).
reln([works,well,with| L],L,O1,O2, [prop(O1, synergizes, O2) | C],C).
reln([pairs,well,with| L],L,O1,O2, [prop(O1, synergizes, O2) | C],C).
reln([is,good,with| L],L,O1,O2, [prop(O1, synergizes, O2) | C],C).
